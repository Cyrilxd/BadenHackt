<template>
  <div class="bg-white dark:bg-gray-900">
    ...
    <main>
      <!-- Pricing section -->
      <form class="group/tiers pt-24 sm:pt-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div class="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            <div v-for="tier in pricing.tiers" :key="tier.id" class="group/tier rounded-3xl p-8 ring-1 ring-gray-200 data-[featured]:ring-2 data-[featured]:ring-indigo-600 xl:p-10 dark:bg-gray-800/50 dark:ring-white/15 dark:data-[featured]:ring-indigo-400" :data-featured="tier.featured ? 'true' : undefined">
      ...
      <div class="mx-auto mt-24 max-w-7xl px-6 sm:mt-56 lg:px-8">
        <div class="mx-auto grid max-w-2xl grid-cols-1 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div class="flex flex-col pb-10 sm:pb-16 lg:pb-0 lg:pr-8 xl:pr-20">
            <img class="h-12 self-start dark:hidden" src="https://tailwindcss.com/plus-assets/img/logos/tuple-logo-gray-900.svg" alt="" />
            <img class="hidden h-12 self-start dark:block" src="https://tailwindcss.com/plus-assets/img/logos/tuple-logo-white.svg" alt="" />
            <figure class="mt-10 flex flex-auto flex-col justify-between">
              ...
              <figcaption class="mt-10 flex items-center gap-x-6">
                <img class="size-14 rounded-full bg-gray-50 dark:bg-gray-800" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />
                <div class="text-base">
                  <div class="font-semibold text-gray-900 dark:text-white">Judith Black</div>
                  <div class="mt-1 text-gray-500 dark:text-gray-400">CEO of Tuple</div>
                </div>
              </figcaption>
            </figure>
          </div>
          <div class="flex flex-col border-t border-gray-900/10 pt-10 sm:pt-16 lg:border-l lg:border-t-0 lg:pl-8 lg:pt-0 xl:pl-20 dark:border-white/10">
            <img class="h-12 self-start dark:hidden" src="https://tailwindcss.com/plus-assets/img/logos/reform-logo-gray-900.svg" alt="" />
            <img class="hidden h-12 self-start dark:block" src="https://tailwindcss.com/plus-assets/img/logos/reform-logo-white.svg" alt="" />
            <figure class="mt-10 flex flex-auto flex-col justify-between">
              <blockquote class="text-lg/8 text-gray-900 dark:text-gray-100">
              ...
              <figcaption class="mt-10 flex items-center gap-x-6">
                <img class="size-14 rounded-full bg-gray-50 dark:bg-gray-800" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />
                <div class="text-base">
                  <div class="font-semibold text-gray-900 dark:text-white">Joseph Rodriguez</div>
                  <div class="mt-1 text-gray-500 dark:text-gray-400">CEO of Reform</div>
                </div>
              </figcaption>
            </figure>
          </div>
      ...
      <div class="mx-auto mt-24 max-w-7xl px-6 sm:mt-56 lg:px-8">
        ...
        <p class="mt-6 max-w-2xl text-base/7 text-gray-600 dark:text-gray-400">Have a different question and can’t find the answer you’re looking for? Reach out to our support team by <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">sending us an email</a> and we’ll get back to you as soon as we can.</p>
        <div class="mt-20">
