  ...
  <div class="bg-white py-24 sm:py-32 dark:bg-gray-900">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
        <div class="lg:pr-4">
          <div class="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10 dark:bg-gray-800 dark:shadow-none dark:after:pointer-events-none dark:after:absolute dark:after:inset-0 dark:after:rounded-3xl dark:after:ring-1 dark:after:ring-inset dark:after:ring-white/10">
            <img class="absolute inset-0 size-full rounded-3xl object-cover brightness-125 saturate-0" src="https://images.unsplash.com/photo-1630569267625-157f8f9d1a7e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2669&q=80" alt="" />
        ...
        <div>
          <div class="text-base/7 text-gray-700 lg:max-w-lg dark:text-gray-400">
            <p class="text-base/7 font-semibold text-indigo-600 dark:text-indigo-400">Company values</p>
            <h1 class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl dark:text-white">On a mission to empower remote teams</h1>
            <div class="max-w-xl">
          ...
          <dl class="mt-10 grid grid-cols-2 gap-8 border-t border-gray-900/10 pt-10 sm:grid-cols-4 dark:border-gray-800">
            <div v-for="(stat, statIdx) in stats" :key="statIdx">
              <dt class="text-sm/6 font-semibold text-gray-600 dark:text-gray-400">{{ stat.label }}</dt>
              <dd class="mt-2 text-3xl/10 font-bold tracking-tight text-gray-900 dark:text-white">{{ stat.value }}</dd>
            </div>
          </dl>
