  ...
  <div class="bg-white py-24 sm:py-32 dark:bg-gray-900">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
        ...
        <h1 class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl dark:text-white">A better workflow</h1>
    ...
    <div class="relative overflow-hidden pt-16 lg:pt-20">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <img class="mb-[-12%] rounded-xl shadow-2xl ring-1 ring-gray-900/10 dark:hidden dark:shadow-xl dark:ring-white/10" src="https://tailwindcss.com/plus-assets/img/component-images/project-app-screenshot.png" alt="" />
        <img class="mb-[-12%] hidden rounded-xl shadow-2xl ring-1 ring-gray-900/10 dark:block dark:shadow-xl dark:ring-white/10" src="https://tailwindcss.com/plus-assets/img/component-images/dark-project-app-screenshot.png" alt="" />
