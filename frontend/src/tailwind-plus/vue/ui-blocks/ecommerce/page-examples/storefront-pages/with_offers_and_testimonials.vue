      ...
      <div class="flex flex-col border-b border-gray-200 lg:border-0">
        ...
        <div class="relative">
          ...
          <div class="h-48 w-full sm:h-64 lg:absolute lg:right-0 lg:top-0 lg:h-full lg:w-1/2">
            <img src="https://tailwindcss.com/plus-assets/img/ecommerce-images/home-page-02-hero-half-width.jpg" alt="" class="size-full object-cover" />
          </div>
        </div>
      </div>
              ...
              <ul role="list" class="mx-4 inline-flex space-x-8 sm:mx-6 lg:mx-0 lg:grid lg:grid-cols-4 lg:gap-x-8 lg:space-x-0">
                <li v-for="product in trendingProducts" :key="product.id" class="inline-flex w-64 flex-col text-center lg:w-auto">
                  <div class="group relative">
                    <img :src="product.imageSrc" :alt="product.imageAlt" class="aspect-square w-full rounded-md bg-gray-200 object-cover group-hover:opacity-75" />
                    <div class="mt-6">
                  ...
                  <ul role="list" class="mt-auto flex items-center justify-center space-x-3 pt-6">
                    <li v-for="color in product.availableColors" :key="color.name" class="size-4 rounded-full border border-black/10" :style="{ backgroundColor: color.colorBg }">
          ...
          <div class="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-32">
            ...
            <div class="mt-6 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0">
              <div v-for="collection in collections" :key="collection.name" class="group relative">
                <img :src="collection.imageSrc" :alt="collection.imageAlt" class="w-full rounded-lg bg-white object-cover group-hover:opacity-75 max-sm:h-80 sm:aspect-[2/1] lg:aspect-square" />
          ...
          <div class="lg:grid lg:grid-cols-2 lg:gap-x-6 xl:gap-x-8">
            ...
            <div class="relative mt-6 flex items-center px-6 py-12 sm:px-10 sm:py-16 lg:mt-0">
              <div class="absolute inset-0 overflow-hidden rounded-lg">
                <img src="https://tailwindcss.com/plus-assets/img/ecommerce-images/footer-02-exclusive-sale.jpg" alt="" class="size-full object-cover saturate-0 filter" />
