...
const orders = [
  {
    ...
    href: '#',
    imageSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/order-history-page-05-product-01.jpg',
  ...
  },
  {
    ...
    href: '#',
    imageSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/order-history-page-05-product-02.jpg',
  ...
  },
  {
    ...
    href: '#',
    imageSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/order-history-page-05-product-03.jpg',
  ...
  },
  {
    ...
    href: '#',
    imageSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/order-history-page-05-product-04.jpg',
  ...
  },
  {
    ...
    href: '#',
    imageSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/order-history-page-05-product-05.jpg',
    imageAlt: 'White canvas laptop sleeve with front pocket and tan zipper pull.',
  },
  {
    id: 6,
    ...
    datetime: '2021-02-17',
    status: 'cancelled',
    productName: 'Shoulder Sling',
    href: '#',
    imageSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/order-history-page-05-product-06.jpg',
    imageAlt: 'Light grey canvas shoulder bag with matching strap, zipper, and metal strap rings.',
  },
  {
    id: 7,
    date: 'January 9, 2021',
    ...
    status: 'delivered',
    active: false,
    productName: 'Crushed Carrier',
    href: '#',
    imageSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/order-history-page-05-product-07.jpg',
    imageAlt: 'Washed grey canvas bag with crumbled body, matching straps, and natural leather drawstring handle.',
  },
  {
    id: 8,
    date: 'January 4, 2021',
    ...
    status: 'delivered',
    active: false,
    productName: 'Wrap Clutch',
    href: '#',
    imageSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/order-history-page-05-product-08.jpg',
