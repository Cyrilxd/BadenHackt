        ...
        <div class="grid grid-cols-1 py-20 md:grid-flow-col md:auto-rows-min md:grid-cols-12 md:gap-x-8 md:gap-y-16">
          ...
          <div class="mt-12 md:col-span-8 md:col-start-3 md:row-start-2 md:mt-0 lg:col-span-4 lg:col-start-9 lg:row-start-1">
            ...
            <form class="mt-3 sm:flex lg:block xl:flex">
              ...
              <div class="mt-4 sm:ml-4 sm:mt-0 sm:shrink-0 lg:ml-0 lg:mt-4 xl:ml-4 xl:mt-0">
      ...
      featured: [
        {
          name: 'Scaffold',
          href: '#',
          imageSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/product-page-05-menu-03.jpg',
          imageAlt:
        ...
        },
        {
          name: 'Bones',
          href: '#',
          imageSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/product-page-05-menu-04.jpg',
          imageAlt:
      ...
      featured: [
        {
          ...
          href: '#',
          imageSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/product-page-05-menu-01.jpg',
          imageAlt:
        ...
        },
        {
          ...
          href: '#',
          imageSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/product-page-05-menu-02.jpg',
